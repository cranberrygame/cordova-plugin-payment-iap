 ...
 * @modifications Sang Ki Kwon (cranberrygame) 8/20/14
 *
 */
...
//cranberrygame start				
				//init(sku);
				String base64EncodedPublicKey = data.getString(1);
				init(sku, base64EncodedPublicKey);
//cranberrygame end
...
//carnberrygame start
	...
	private void init(final List<String> skus, String base64EncodedPublicKey){
//carnberrygame end
