 ...
 * Modifications 8/20/2014 by Sang Ki Kwon (cranberrygame)
 */
...
InAppBilling.prototype.init = function (success, fail, options, skus, base64EncodedPublicKey) {
//cranberrygame end
	options || (options = {});
...
//cranberrygame start	
		...
		return cordova.exec(success, fail, "InAppBillingPlugin", "init", [skus,base64EncodedPublicKey]);
//cranberrygame start		
    }else {
//cranberrygame start	
        //No SKUs
		//return cordova.exec(success, fail, "InAppBillingPlugin", "init", []);
		return cordova.exec(success, fail, "InAppBillingPlugin", "init", [[],base64EncodedPublicKey]);
//cranberrygame end
    }
};
